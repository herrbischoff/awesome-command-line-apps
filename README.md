...
- [fossil](https://fossil-scm.org) - Fossil is a complete distributed version control system by the creators of sqlite which includes web gui, ticketing system, wiki and forums in one binary.
