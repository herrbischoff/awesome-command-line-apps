...
- [Oxipng](https://github.com/shssoichiro/oxipng) - Multi-threaded PNG optimizer that recompresses image files to a smaller size, without losing any information.
